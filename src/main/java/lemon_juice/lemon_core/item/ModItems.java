...
public class ModItems {
    ...
    // Vanilla Compat (Dusts)
    public static final RegistryObject<Item> IRON_DUST = ITEMS.register("iron_dust", () -> new MetalDustItem(new Item.Properties(), "Vanilla", false));
    public static final RegistryObject<Item> GOLD_DUST = ITEMS.register("gold_dust", () -> new MetalDustItem(new Item.Properties(), "Vanilla", false));
    public static final RegistryObject<Item> COPPER_DUST = ITEMS.register("copper_dust", () -> new MetalDustItem(new Item.Properties(), "Vanilla", false));
    public static final RegistryObject<Item> NETHERITE_DUST = ITEMS.register("netherite_dust", () -> new MetalDustItem(new Item.Properties(), "Vanilla", true));
    ...
    public static final RegistryObject<Item> OBSIDIAN_DUST = ITEMS.register("obsidian_dust", () -> new IntegrationTooltipItem(new Item.Properties(), "Vanilla"));
